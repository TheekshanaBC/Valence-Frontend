...
export function NativeNetworkTopology() {
  ...
  return (
    <div className="w-full relative overflow-hidden rounded-2xl bg-[#090416]/95 border border-[rgba(139,92,246,0.2)] p-4 sm:p-8 shadow-[inset_0_2px_24px_rgba(0,0,0,0.8)]">
      ...
      <div className="relative z-10 flex flex-wrap items-center justify-between gap-3 mb-8 pb-4 border-b border-[rgba(139,92,246,0.12)]">
        <div>
        ...
        <div className="flex items-center gap-3 text-xs font-mono text-slate-400">
          <span className="flex items-center gap-1.5">
            <span className="w-2 h-2 rounded-full bg-violet-400 animate-pulse" /> Public Traffic
          </span>
          <span className="flex items-center gap-1.5">
      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
        ...
        >
          <div className="flex items-center gap-2.5 mb-3">
            <div className="w-8 h-8 rounded-lg bg-violet-400/10 border border-violet-400/30 flex items-center justify-center text-violet-400">
              <Laptop className="w-4 h-4" />
            </div>
            <div>
              <span className="text-[9px] font-mono uppercase text-violet-400 tracking-wider block">Zone 1</span>
          ...
          <div className="space-y-2.5">
            ...
            <div className="p-3 rounded-xl bg-violet-500/5 border border-violet-400/25">
        ...
        <div className="lg:col-span-1 hidden lg:flex flex-col items-center justify-center gap-2">
          <span className="text-[9px] font-mono text-violet-400 text-center uppercase tracking-widest">
            HTTPS / REST
          </span>
          <div className="w-full flex items-center justify-center">
            <div className="h-0.5 w-full bg-gradient-to-r from-violet-400 to-violet-500 relative">
              <motion.div
                animate={{ x: [0, 40, 0] }}
                transition={{ duration: 2, repeat: Infinity, ease: "easeInOut" }}
                className="absolute -top-1 w-2 h-2 rounded-full bg-violet-300 shadow-[0_0_8px_rgba(139,92,246,1)]"
              />
            </div>
          </div>
        ...
        >
          <div className="flex items-center gap-2.5 mb-3">
            ...
            <div>
              <span className="text-[9px] font-mono uppercase text-violet-400 tracking-wider block">Zone 2</span>
        ...
        <div className="lg:col-span-1 hidden lg:flex flex-col items-center justify-center gap-2">
          ...
          <div className="w-full flex items-center justify-center">
            <div className="h-0.5 w-full bg-gradient-to-r from-violet-400 via-amber-400 to-emerald-400 relative">
              <motion.div
                animate={{ x: [0, 40, 0] }}
        ...
        >
          ...
          <div className="mt-3 pt-2.5 border-t border-[rgba(139,92,246,0.1)] flex items-center justify-between text-[10px] font-mono text-emerald-400">
            <span>Keepalive:</span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="p-5 rounded-xl bg-[#0f0726]/80 border border-[rgba(139,92,246,0.15)] space-y-3 flex flex-col justify-between">
          <div>
            ...
            <span className="text-[10px] font-mono uppercase text-violet-400">Step 2 • SeenCache Filter</span>
