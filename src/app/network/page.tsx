    ...
    <div className="min-h-screen pb-24">
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 space-y-10">
        ...
        <section className="glass-panel rounded-2xl p-6 sm:p-8 space-y-6">
          ...
          {/* Clean SVG Diagram */}
          <div className="w-full bg-[#03090e] rounded-xl p-4 sm:p-6 border border-[rgba(139,92,246,0.15)] overflow-x-auto">
            <svg
              viewBox="0 0 760 210"
            ...
            >
              {/* Box 1: Website */}
              <rect x="20" y="30" width="180" height="130" rx="10" fill="#071422" stroke="rgba(139,92,246,0.4)" strokeWidth="1.5" />
              ...
              <rect x="290" y="30" width="190" height="130" rx="10" fill="#071422" stroke="rgba(139,92,246,0.4)" strokeWidth="1.5" />
          ...
          <section className="glass-panel rounded-2xl p-6 sm:p-8 space-y-4">
            ...
            <div className="space-y-3 text-base text-slate-300 font-light leading-relaxed">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
                <div className="p-3.5 rounded-xl bg-[#03090e] border border-[rgba(139,92,246,0.1)]">
          ...
          <section className="glass-panel rounded-2xl p-6 sm:p-8 space-y-4">
            ...
            <div className="space-y-3 text-base text-slate-300 font-light leading-relaxed">
              ...
              <div className="space-y-2.5 pt-2">
                <div className="p-3.5 rounded-xl bg-[#03090e] border border-[rgba(139,92,246,0.1)] flex items-start gap-3">
