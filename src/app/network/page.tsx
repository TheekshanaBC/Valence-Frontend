    ...
    <div className="min-h-screen pb-24">
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 space-y-10">
        ...
        <section className="glass-panel rounded-2xl p-6 sm:p-8 space-y-6">
          ...
          {/* Clean SVG Diagram */}
          <div className="w-full bg-[#03090e] rounded-xl p-4 sm:p-6 border border-[rgba(6,182,212,0.15)] overflow-x-auto">
            <svg
              viewBox="0 0 760 210"
            ...
            >
              {/* Box 1: Website */}
              <rect x="20" y="30" width="180" height="130" rx="10" fill="#071422" stroke="rgba(6,182,212,0.4)" strokeWidth="1.5" />
              ...
              <text x="110" y="105" textAnchor="middle" fill="#22d3ee" fontSize="10">• Signs Tx in browser (Ed25519)</text>
              <text x="110" y="125" textAnchor="middle" fill="#22d3ee" fontSize="10">• Queries /status, /chain</text>
              <text x="110" y="145" textAnchor="middle" fill="#22d3ee" fontSize="10">• Submits POST /tx/submit</text>

              {/* Arrow 1: Website <-> Cloud Node */}
              <line x1="200" y1="95" x2="280" y2="95" stroke="#06b6d4" strokeWidth="1.5" strokeDasharray="4 4" />
              <polygon points="280,95 272,91 272,99" fill="#06b6d4" />
              <polygon points="200,95 208,91 208,99" fill="#06b6d4" />
              <text x="240" y="85" textAnchor="middle" fill="#22d3ee" fontSize="10">HTTPS REST</text>

              {/* Box 2: Cloud RPC Node */}
              <rect x="290" y="30" width="190" height="130" rx="10" fill="#071422" stroke="rgba(6,182,212,0.4)" strokeWidth="1.5" />
              ...
              <text x="385" y="105" textAnchor="middle" fill="#22d3ee" fontSize="10">• Public valenced Node</text>
              <text x="385" y="125" textAnchor="middle" fill="#22d3ee" fontSize="10">• Holds Faucet Key</text>
              <text x="385" y="145" textAnchor="middle" fill="#22d3ee" fontSize="10">• Acts as Seed Bootstrap</text>
              ...
              <rect x="570" y="30" width="170" height="130" rx="10" fill="#071422" stroke="rgba(16,185,129,0.4)" strokeWidth="1.5" />
        ...
        <div className="space-y-6">
          ...
          <section className="glass-panel rounded-2xl p-6 sm:p-8 space-y-4">
            ...
            <div className="space-y-3 text-base text-slate-300 font-light leading-relaxed">
              ...
              <p>
                Because they are on the same machine, they connect directly via <code className="text-cyan-300">http://localhost:8080</code> and <code className="text-cyan-300">http://localhost:8081</code>. When Node A receives or mines something, it sends a direct HTTP POST request (<code className="text-cyan-300">POST /tx/gossip</code> or <code className="text-cyan-300">POST /block/gossip</code>) to Node B.
              </p>
            </div>
          </section>
